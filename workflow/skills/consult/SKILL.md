---
name: consult
description: Provide read-only technical advice for an architecture decision, design, problem diagnosis, proposed change, or implementation plan. Use when the agent should assess options, recommend an approach, or evaluate risks before changes are made.
---
